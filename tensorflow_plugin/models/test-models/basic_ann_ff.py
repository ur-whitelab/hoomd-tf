...
def build_neural_network(x, weights, biases, keep_prob, N_nodes, N_layers):
...
def make_train_graph(NN, N_hidden_nodes, N_hidden_layers):
    ...
    output_layer = build_neural_network(r_inv, weights, biases, keep_prob, N_hidden_nodes, N_hidden_layers)
