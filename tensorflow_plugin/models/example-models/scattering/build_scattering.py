...
intensities = tf.multiply(0.5,  tf.reduce_sum(tf.reduce_sum(b*b* tf.sin(qr) * graph_builder.safe_div(1., qr), axis = 2), axis=1))
...
graph.save(model_directory='/scratch/hgandhi/scattering/',  out_nodes = [avg_op, steps_1])
